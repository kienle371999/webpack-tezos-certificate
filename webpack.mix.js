    ...
    return {
        ...
        plugins: [
            new webpack.DefinePlugin({
                'process.env': {
                    'VUE_APP_BLOCKCHAIN_URL': JSON.stringify(process.env.VUE_APP_BLOCKCHAIN_URL),
                    'VUE_APP_TEZOS_URL': JSON.stringify(process.env.VUE_APP_TEZOS_URL),
                    'VUE_APP_PDF_URL': JSON.stringify(process.env.VUE_APP_PDF_URL)
                }
            })
        ]
    };
