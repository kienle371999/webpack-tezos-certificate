...
export declare namespace TezosNodeWriter {
    ...
    function sendContractOriginationOperation(server: string, keyStore: KeyStore, amount: number, delegate: string | undefined, fee: number, derivationPath: string | undefined, storage_limit: number, gas_limit: number, code: string, storage: string, codeFormat?: TezosTypes.TezosParameterFormat): Promise<TezosTypes.OperationResult>;
